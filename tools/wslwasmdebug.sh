...
"$EMCC" -O1 -g2 -msimd128 -Isrc -c src/cudakernels.c -o build/wasm/cudakernels_dbg.o

echo "== building web/x86emu_cuda_dbg.js"
"$EMXX" -std=c++17 -O1 -g2 --profiling-funcs -msimd128 -DVVCUDA_SHIM \
    ...
    -sEXPORTED_FUNCTIONS='["_emu_run","_emu_run_path","_emu_set_sysroot","_emu_error","_emu_format","_emu_instructions","_malloc","_free"]' \
